            ...
            <div class="col-12">
                ...
                <div class="details-card p-4 rounded">
                    <div class="border-bottom pb-3 mb-4">
                        <h4 class="fw-semibold mb-2">Создание нового маршрута</h4>
                    ...
                    <form id="routeForm" method="POST" action="${ctx}/company/routes" class="needs-validation" novalidate>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="citySelect" name="cityId" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="transportSelect" name="transportModeId" required>
                            ...
                            <div class="col-md-4">
                                <label for="routeNumber" class="form-label">Номер маршрута <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="routeNumber" name="routeNumber"
                                       placeholder="Например: 12А" maxlength="20" required>
                                <div class="invalid-feedback">Введите номер</div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 pt-3">
                            <button type="submit" id="submitBtn" class="btn btn-cta px-4">
                                <i class="bi bi-check-circle me-2"></i>Создать маршрут
                            </button>
                        </div>
                    </form>
                </div>
...
<script src="${ctx}/assets/js/route-form.js"></script>
